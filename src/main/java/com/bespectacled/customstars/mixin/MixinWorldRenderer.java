...
public class MixinWorldRenderer {
    ...
    private void reloadStars(CallbackInfo info) {
        if (CustomStars.shouldReloadStars()) {
            ...
            this.renderCustomStars(builder);
    ...
    private void injectRenderStars(BufferBuilder builder, CallbackInfo info) {
        this.renderCustomStars(builder);
    ...
    @Unique
    private void renderCustomStars(BufferBuilder buffer) {
        ...
        AtomicSimpleRandom fieldRandom = new AtomicSimpleRandom(seed);
